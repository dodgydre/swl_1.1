...
add_action('tgmpa_register', 'swl_register_required_plugins');
 ...
 */
function swl_register_required_plugins()
{
    /*
     ...
     */
    $config = array(
        'id' => 'swl_',                 // Unique ID for hashing notices for multiple instances of TGMPA.
